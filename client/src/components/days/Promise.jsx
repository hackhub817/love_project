    ...
    <>
      ...
      >
        <div className="max-w-4xl mx-auto ">
            ...
            <div className="flex lg:gap-10 sm:gap-10 gap-1 gap lg:-mt-10 sm:-mt-10 -mt-5 px-2">
              <div>
                ...
                <div className="lg:w-64 lg:h-64 sm:w-64 sm:h-64  w-24 h-32">
                  {getImages(1, 2).map((imageUrl, idx) => (
                    <img
                      src={imageUrl}
                      alt=""
                      className="lg:border-[10px] lg:border-b-[50px] sm:border-[10px] sm:border-b-[50px] border-[5px] border-b-[10px] border-[#51A9FE]"
                    />
                  ))}
                </div>
              </div>
              <div>
                ...
                <div className="lg:w-48 lg:h-48 sm:w-48 sm:h-48 h-12 w-24">
                  {getImages(2, 3).map((imageUrl, idx) => (
                    <img
                      src={imageUrl}
                      alt=""
              ...
              <div>
                <div className="lg:h-44 sm:h-44 h-32 w-1 lg:ml-28 sm:ml-28 ml-10 bg-[#51A9FE]"></div>
                <div className="lg:w-64 lg:h-64 sm:w-64 sm:h-64 w-24 h-32">
                  {getImages(3, 4).map((imageUrl, idx) => (
                    <img
                      src={imageUrl}
                      alt=""
                      className=" lg:border-[10px]  lg:border-b-[50px] sm:border-[10px]  sm:border-b-[50px] border-[5px] border-b-[10px] border-[#51A9FE]"
          ...
          <div className="lg:px-10 sm:px-10 px-1  lg:py-20 sm:py-20 py-10 flex items-center lg:gap-12 sm:gap-12 gap-2">
            {getImages(4, 6).map((imageUrl, idx) => (
              <div className="relative lg:border-[20px] sm:lg:border-[20px] border-[8px] border-[#A3CFF9] rounded-2xl">
                {" "}
                <img
                  src={imageUrl}
                  alt=""
                  className="lg:h-64 lg:w-80 sm:h-64 sm:w-80 rounded-2xl h-32 w-64"
                />
                <img
                  src={dance}
                  alt=""
